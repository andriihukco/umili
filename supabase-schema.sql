-- Umili Freelance Marketplace Database Schema - Fresh Implementation
...
CREATE INDEX idx_tasks_freelancer_id ON public.tasks(freelancer_id);
...
CREATE INDEX idx_users_current_tier_id ON public.users(current_tier_id);
CREATE INDEX idx_subscription_tiers_role ON public.subscription_tiers(role);
